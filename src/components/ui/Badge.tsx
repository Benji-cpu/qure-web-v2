  ...
  return (
    <span
      className={cn(
        ...
        variant === 'default' && 'bg-[var(--color-glass-input)] backdrop-blur-lg text-[var(--color-text-secondary)]',
        ...
        variant === 'secondary' && 'bg-[var(--color-glass-input)] backdrop-blur-lg text-[var(--color-text-tertiary)]',
        className,
      )}
    >
      {children}
